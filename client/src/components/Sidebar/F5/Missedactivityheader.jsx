...
export default function Missedactivityheader(props){
    ...
    <div className="activityBar aba" style={{display:"flex", flexDirection:"row"}}>Missed Activities on <p className="missedActivityDate" style={{marginLeft:"20px", marginBottom:"0px",  marginTop: "4px", paddingLeft: "10px", paddingRight: "10px", height:"20px", display:"flex", alignItems:"center", fontFamily : "Cambria, Cochin, Georgia, Times, 'Times New Roman', serif", color:"white" , backgroundImage: "linear-gradient(to right ,rgb(42, 42, 243), rgba(144, 10, 144, 0.925))"}}>{props.date}</p></div>
